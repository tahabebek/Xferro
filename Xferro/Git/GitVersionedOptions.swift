...
extension git_checkout_options: GitVersionedOptions {
  ...
  static func defaultOptions(strategy: git_checkout_strategy_t) -> git_checkout_options {
...
extension git_commit_create_options: GitVersionedOptions {
  ...
  static func initialize(options: UnsafeMutablePointer<Self>?, version: UInt32) -> Int32 {
      options?.pointee = Self(
        version: version,
