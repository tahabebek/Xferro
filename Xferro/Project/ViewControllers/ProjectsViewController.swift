...
class ProjectsViewController: NSViewController {
    ...
    private func showSelectProjectView(for user: User) {
        let selectProjectViewController = SelectProjectViewController(user: user)
        ...
        selectProjectViewController.view.widthAnchor.constraint(equalTo: view.widthAnchor).isActive = true
        selectProjectViewController.view.heightAnchor.constraint(equalTo: view.heightAnchor).isActive = true
    }
}
